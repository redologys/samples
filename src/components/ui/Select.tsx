    ...
    <SelectPrimitive.Content
      ...
      className={cn(
        `relative z-50 max-h-96 min-w-[8rem] overflow-hidden
         rounded-xl border border-neutral-800 bg-neutral-900 text-white
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn("px-3 py-2 text-xs font-semibold text-neutral-400 uppercase tracking-wider", className)}
    {...props}
  />
));
